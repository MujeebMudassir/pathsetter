...
import image from "../../assets/images/productImages/Dashboard-1.jpg";
    ...
    <div className="w-full overflow-hidden ">
      ...
      <div className="h-[100vh]  max-w-[95vw] md:max-w-[1350px]  mx-auto w-full flex flex-col justify-center items-center relative text-white">
        ...
        >
          ...
          <p
            className={`text-[20px]  text-center  opacity-0  ${
          ...
          <h1
            className={`text-[30px] font-bold opacity-0 text-center md:text-[45px] ${
              animated ? "animate-slide-up2" : ""
            } md:text-[45px]`}
          >
            AI-Driven Automation for Comprehensive
            ...
            <div className="cube-container">
              <div className="cube">
                <div className="cube-face front">Insights</div>
                <div className="cube-face back">Analyses</div>
                <div className="cube-face top">Datasets</div>
                <div className="cube-face bottom">Charts</div>
              </div>
            </div>
            Generation
          </h1>
          ...
          >
            <p className="text-2xl mt-6">
              Empower your business with AI-powered precision in every dataset.
            </p>
            ...
            <button
              ...
              className="bg-purple-700 px-8 py-3 mt-7 rounded-3xl text-xl"
            >
              Book a Demo
            </button>
          </p>
      ...
      <div className="text-center max-w-[95vw] md:max-w-[1350px] mx-auto  flex flex-col justify-center items-center relative text-white">
        ...
        >
          Unveil the Core Features of Data Dynamo
        </h2>
        <p className="text-2xl  mb-5">
          Leverage an AI analyst to quickly extract data and insights across
            ...
            <div className="grid md:grid-cols-2 mx-auto w-full ">
              <div className="flex p-5 justify-center items-center flex-col w-full border-b-2  md:border-r-2 border-gray-700">
                <div className="group text-center  cursor-pointer transition ease-in-out hover:-translate-y-1 hover:scale-110">
                  ...
                  <p className="text-white text-xl w-80 flex text-center mt-4">
                    Integrate and update data from various sources instantly for
                    the latest insights.
                  </p>
                </div>
              </div>
              <div className="flex p-5 justify-center items-center flex-col border-b-2 border-gray-700">
                <div className="group text-center transition ease-in-out hover:-translate-y-1 hover:scale-110">
                  ...
                  <p className="text-white text-xl w-80 flex text-center mt-4">
                    Use natural language queries to interact with data for clear
                    and precise answers.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 w-full  mx-auto rounded-b-lg ">
              <div className="flex p-5 justify-center items-center flex-col border-b-2 md:border-b-0 md:border-r-2  border-gray-700">
                <div className="group text-center transition ease-in-out hover:-translate-y-1 hover:scale-110">
                  ...
                  <p className="text-white text-xl w-80 flex text-center mt-4">
                    Drill down from high-level summaries to detailed trends and
                    patterns.
                  </p>
                </div>
              </div>
              <div className="flex p-5 justify-center items-center flex-col ">
                <div className="group text-center transition ease-in-out hover:-translate-y-1 hover:scale-110">
                  ...
                  <p className="text-white text-2xl mt-2">Annotation of Data</p>
                  <p className="text-white text-xl w-80 flex text-center mt-4">
                    Add context and notes to data for better clarity and team
                    collaboration.
                  </p>
                </div>
              </div>
      ...
      <div className="text-center md:max-w-[1350px] max-w-[90vw] mx-auto w-full flex flex-col justify-center items-center relative text-white mt-10">
        <p
          className={`text-[10px] md:text-[20px] text-center  opacity-0  ${
            animated ? "animate-slide-up3" : ""
          } `}
        >
          {/* <button className="bg-sky-600 px-5 h-12 mt-20 mb-6 rounded-3xl font-bold text-white">
            Interactive View of Data Dynamo
          </button> */}
        </p>

        <h2
          className={`text-[20px] font-bold opacity-0 text-center text-white ${
            animated ? "animate-slide-up2" : ""
          } md:text-[40px]`}
        >
        ...
        >
          <p className="text-2xl  text-white ">
            Discover how Data Dynamo transforms prompts into dynamic, real-time
            options.
          </p>
        </p>
      </div>
      ...
      <div className="relative min-h-[600px]" ref={containerRef3}>
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-[95vw] md:max-w-[1350px] md:w-[80vw] mx-auto text-white mt-10 mb-16 ">
          {/* <div
            ...
            <div className="product-bg-gradient transition-all ease-in h-full">
              <div className="p-10">
                ...
                <p className="text-xl w-5/5">
                  Receive actionable insights designed to drive immediate and
                  effective decisions, helping you respond quickly to
              ...
              <div className="p-10">
                ...
                <p className="text-xl w-5/5">
                  Utilize a platform specifically tailored to meet your
                  organization’s unique needs, ensuring alignment with your
          ...
          <div className="grid gap-10">
            ...
            >
              <div className="mt-10 mb-10 ml-10">
                <button className="w-20 h-20 flex justify-center items-center rounded-md pt-4">
                  {View1}
                </button>
                <p className="text-[30px] md:text-[30px] font-semibold pt-6">
                  Action-Oriented Insights
                </p>
                <p className="text-xl w-4/5 pb-8">
                  Receive actionable insights designed to drive immediate and
                  effective decisions, helping you respond quickly to
                  opportunities and challenges.
                </p>
          ...
          <div className="grid gap-10">
            ...
            >
              <div className="mt-10 mb-10 ml-10">
                ...
                <p className="text-xl w-4/5">
                  Benefit from a system that evolves with advancements in Large
                  Language Models (LLMs), providing you with the latest features
                  and improvements to stay ahead of industry trends.
                </p>
              </div>
            </div>
            <div
            ...
            >
              <div className="mt-10 mb-10 ml-10">
                ...
                <p className="text-xl w-4/5">
                  Access detailed insights from a wide range of data types,
                  including historical and disparate sources, for a holistic
                  view that supports informed decision-making.
                </p>
              </div>
            </div>
          </div>
      ...
      <div>
        ...
        >
          <p className="text-2xl  text-white mb-5">
            Engage with industry leaders and peers to unlock new opportunities
